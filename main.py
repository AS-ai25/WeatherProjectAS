...
st.write(
    "Get real-time weather updates and hand-picked attractions tailored to the current conditions. Whether it’s sunny skies or rainy days, we’ll guide you to the best experiences in your chosen city – from nature walks and panoramic viewpoints to cozy museums and local gems.")
...
st.write(
    f"The time now in {city} is {actual_cite_time1} and the weather there is {weather_description}, {main_temp} {temp_sym}.\n")
